...
print()
# Вопрос 3
# The following code can lead to an infinite loop. Fix the code so that
# it can finish successfully for all numbers.
...
# of a number, without including it. A divisor is a number that divides
# into another without a remainder.
def sum_divisors(n):
  sum = 0
  for i in range(1, n):
      if n % i == 0 and n!=0:
...
# to it multiplied by 1 through 5. An additional requirement is that
